...
if(!empty($result)) {
    ...
    // 管理员登录失败
	echo "<script language=javascript>alert('用户名或密码不正确');window.location='landing.php'</script>";
	}
}
?>
...
<table width="782" border="0" align="center" cellpadding="5" cellspacing="1" bgcolor="#CCCCCC">
  ...
  <tr>
    <td align="right" bgcolor="#FFFFFF"><a href="reg.php"><input type="button" value="注册"></a>
      </td>
